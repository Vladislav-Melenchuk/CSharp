...
namespace HW_interface
{
    public class Student: ICloneable
    {
      ...
      : this(Surname, Name, Otchestvo, birthday, "", PhoneNumber, new List<int>(), new List<int>(), new List<int>())
        ...
        public object Clone()
        {
            return new Student(surname, name, otchestvo, birthday, address, phoneNumber, new List<int>(credits), new List<int>(coursework), new List<int>(exams));
        }
        ...
        public class SortByAverageGrade : IComparer<Student>
        {
            public int Compare(Student x, Student y)
            {
                ...
                double avgX = x.GetAverageGrade();
                double avgY = y.GetAverageGrade();

                return avgX.CompareTo(avgY); 
            }
        }
        ...
        public class SortByFullName : IComparer<Student>
        {
            public int Compare(Student x, Student y)
            {
                ...
                string fullNameX = x.surname + " " + x.name + " " + x.otchestvo;
                string fullNameY = y.surname + " " + y.name + " " + y.otchestvo;

                return fullNameX.CompareTo(fullNameY); 
            }
        }
